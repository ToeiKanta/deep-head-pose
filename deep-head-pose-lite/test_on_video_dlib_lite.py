...
def parse_args():
    ...
    parser.add_argument('--scale', metavar='FLOAT', dest='scale', type=float, default=1.0, help='Video scale.')
...
if __name__ == '__main__':
    ...
    out = cv2.VideoWriter('output/video/output-%s.avi' % args.output_string, fourcc, args.fps, (int(width*scale), int(height*scale)))
